...
void DX11CustomRenderTarget::Clear( ID3D11DeviceContext* pd3dDeviceContext )
{
	for (UINT i = 0; i < m_uNumTargets; i++)
	{
	...
	pd3dDeviceContext->ClearDepthStencilView( m_DepthStencilDSV, D3D11_CLEAR_DEPTH, 1.0, 0);
}
