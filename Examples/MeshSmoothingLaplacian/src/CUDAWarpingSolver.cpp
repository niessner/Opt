...
void CUDAWarpingSolver::solveGN(float3* d_vertexPosFloat3, int* d_numNeighbours, int* d_neighbourIdx, int* d_neighbourOffset, float3* d_vertexPosTargetFloat3, int nonLinearIter, int linearIter, float weightFit, float weightReg)
{
