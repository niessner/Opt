...
void CUDAWarpingSolver::solveGN(float3* d_image, float3* d_target, float3* d_auxFloat3CM, float3* d_auxFloat3CP, float3* d_auxFloat3MC, float3* d_auxFloat3PC, unsigned int nNonLinearIterations, unsigned int nLinearIterations, float weightFitting, float weightRegularizer, float weightBeta)
{
	m_solverState.d_target = d_target;
	m_solverState.d_x = d_image;
	m_solverState.d_auxFloat3CM = d_auxFloat3CM;
	m_solverState.d_auxFloat3CP = d_auxFloat3CP;
	m_solverState.d_auxFloat3MC = d_auxFloat3MC;
	m_solverState.d_auxFloat3PC = d_auxFloat3PC;
	...
	parameters.weightBeta = weightBeta;
