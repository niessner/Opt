...
unique_ptr<ceres::Solver::Options> CeresSolverBase::initializeOptions(const NamedParameters& solverParameters) const {
    unique_ptr<ceres::Solver::Options> options = unique_ptr<ceres::Solver::Options>(new ceres::Solver::Options());
...
double CeresSolverBase::launchProfiledSolveAndSummary(const unique_ptr<ceres::Solver::Options>& options, ceres::Problem* problem, bool profileSolve, std::vector<SolverIteration>& iters) {
